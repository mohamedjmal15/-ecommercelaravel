                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="addSlide">
                            <div class="form-group">
                                <label class="col-md-4 contol-label">Title</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 contol-label">Subtitle</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 contol-label">Price</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 contol-label">Image</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 contol-label">Status</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 contol-label"></label>
                                <div class="col-md-4">
